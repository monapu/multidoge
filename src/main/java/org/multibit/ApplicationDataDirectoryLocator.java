...
public class ApplicationDataDirectoryLocator {
     ...
     * 
     * 1. See if there is a multimona.properties in MultiMona's current working
     ...
     * 
     * PC System.getenv("APPDATA")/MultiMonaInExecutableJar
     * 
     * e.g. C:/Documents and Settings/Administrator/Application Data/MultiMonaInExecutableJar
     * 
     * Mac System.getProperty("user.home")/Library/Application Support/MultiMonaInExecutableJar
     * 
     * e.g. /Users/jim/Library/Application Support/MultiMonaInExecutableJar
     * 
     * Linux System.getProperty("user.home")/MultiMonaInExecutableJar
     * 
     * e.g. /Users/jim/MultiMonaInExecutableJar
     */
    public String getApplicationDataDirectory() {
        ...
        if (multibitPropertiesFile.exists()) {
            ...
            if (operatingSystemName != null && operatingSystemName.startsWith("Windows")) {
                // Windows os
                applicationDataDirectory = System.getenv("APPDATA") + File.separator + "MultiMona";
            } else {
                if (operatingSystemName != null && operatingSystemName.startsWith("Mac")) {
                    ...
                    if ( (new File("../../../../" + FileHandler.USER_PROPERTIES_FILE_NAME)).exists()) {
                        ...
                        applicationDataDirectory = System.getProperty("user.home") + "/Library/Application Support/MultiMona";
                    }
                } else {
                    // treat as Linux/ unix variant
                    applicationDataDirectory = System.getProperty("user.home") + "/MultiMona";
                }
            }
     ...
     * This is the directory into which MultiMona was installed.
     * @throws IOException 
     * 
