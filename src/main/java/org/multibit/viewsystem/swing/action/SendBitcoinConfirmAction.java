...
/**
 * This {@link Action} shows the send monacoin confirm dialog or validation dialog on an attempted spend.
 */
public class SendBitcoinConfirmAction extends MultiBitSubmitAction {
    ...
    /**
     * Complete the transaction to work out the fee) and then show the send monacoin confirm dialog.
     */
    @Override
