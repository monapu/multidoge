 ...
 */
public class ShowPreferencesPanel extends JPanel implements Viewable, PreferencesDataProvider, ChangeListener {
  ...
  private MultiBitLabel feeValueLabel;
  ...
  private JPanel createTickerPanel(int stentWidth) {
    ...
    constraints.gridwidth = 3;
    constraints.anchor = GridBagConstraints.LINE_START;
    tickerPanel.add(MultiBitTitledPanel.createStent(1, 25), constraints);
