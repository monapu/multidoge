...
public class SendBitcoinNowActionTest extends TestCase {
    ...
    private static final String EXPECTED_SEND_FAILED = "The send of your monacoin failed.";
    private static final String EXPECTED_THE_WALLET_IS_BUSY = "The wallet is busy with the task \"\"";
    private static final String EXPECTED_YOUR_BITCOIN_WERE_SENT_SUCCESSFULLY = "Your monacoin were sent successfully.";
    private static final String EXPECTED_SENDING_BITCOIN = "Sending monacoin...";
    ...
    private File createMultiBitRuntime() throws IOException {
        ...
        File multibitCheckpoints = new File(multiBitDirectoryPath + File.separator + "multimona.checkpoints");
        FileHandler.copyFile(new File("./src/main/resources/multimona.checkpoints"), multibitCheckpoints);
